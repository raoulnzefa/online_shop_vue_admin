  ...
  <div class="nav-container">
    ...
    <div class="right-container">
      ...
      <el-tooltip content="用户身份" placement="bottom">
        <el-tag class="level">{{ user.consumerLevel }}</el-tag>
      </el-tooltip>
      <el-dropdown class="dropdown" trigger="click" @command="handleCommand">
<!--        <img class="avatar" />-->
        <img :src="'https://carlover.oss-cn-hangzhou.aliyuncs.com/images/clothes.png'" class="user-avatar" />
        <i class="el-icon-arrow-down el-icon--right"></i>
        <el-dropdown-menu slot="dropdown">
          <el-dropdown-item icon="el-icon-s-custom" command="personCenter"
            >个人中心</el-dropdown-item
          >
          <el-dropdown-item divided icon="el-icon-moon" command="logout"
...
// import { getConsumerInfo } from "../../../api/consumerApi";
